...
#                                                                             
# PROGRAMMER:Abhay Joshi
# DATE CREATED:                                  
# REVISED DATE:25-10-2020 
...
def calculates_results_stats(results_dic):
    ...
    """ 
#Create empty dictionary name results_file
    results_stats_dic=dict()
# allocating all initial values to "0" and then we will increment the value with 1
#information related to assigning and naming convenction taken from hint
